...
if(isset($_POST['submit']))
{
    ...
    $name=$_POST['name'];$password=$_POST['password'];
     ...
     if($count==1) {
         ...
         $_SESSION['name'] = $name; $_SESSION['password'] = $password;
...
<div style="position:sticky">
  ...
  <form class="form-container" method="POST" action="login1.php">
  <div class="mb-3">
    <label for="formGroupExampleInput" class="form-label">Name</label>
    <input type="text" name="name" class="form-control" id="exampleFormControlInput1" aria-describedby="emailHelp">
