...
mysqli_query($con,"INSERT INTO user(name,password,email) VALUES( '$name','$password','$email')");
...
<title>Page Title</title>
  ...
  color: white;
        ...
        background-image: url("doodles/health(17).jpg") ;
            height:100%;
            width:100%;
            background-size: 100%
...
<div style="position:sticky">
  ...
  <div class="mb-3">
    ...
    <input placeholder="New Registration" type="text" name="name" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
    <div id="emailHelp" class="form-text">We'll never share your credantials with anyone else.</div>
  </div>
  ...
  <button type="submit" name="submit" class="btn btn-primary">Submit</button>
    ...
    <div style ="height:300px width:100%"class="wate">"</div>
